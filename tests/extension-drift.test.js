...
const IDENTICAL_FUNCTIONS = [
  ...
  "getDeclaredTotalEpisodeCount",
  "getStoredSubjectDeclaredTotalEpisodeCount",
  "getCollectionPartBindingKey",
  "getCollectionPartDirectBindingSubjectId",
  "getCurrentDirectBindingSubjectId",
  "isCurrentOrdinaryEpisodeCollection",
  ...
  "isBilibiliCollectionArchiveTitle",
  "resolveCurrentPageTitle",
  "suggestSearchKeyword",
  "getCurrentPageSearchKeyword",
  "isStandaloneBilibiliPartTitle",
  "renderInlineAutoPreview",
  "renderNonMainPreviewStatus",
...
for (const name of [
  ...
  "getSubjectDeclaredTotalEpisodeCountForMapping",
